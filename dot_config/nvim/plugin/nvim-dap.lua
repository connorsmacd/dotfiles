...
--
-- mason-nvim-dap is set up here rather than in its own file: it needs nvim-dap loaded, and
-- keeping it inside this deferred block avoids pulling the whole debugger in at startup.
-- Note the old spec depended on `williamboman/mason.nvim` here while the rest of the config
-- used `mason-org/mason.nvim`; lazy.nvim deduplicated those by name, vim.pack would clone both.
